...
public class ForumUtilities {
    ...
    public static final String KEY_REF_LOCATION = "database_location";
    public static final String KEY_FORUM_IMAGE_STR = "Forum Image";
    public static final String KEY_FORUM_TAB_STR = "Forum Tab";
    public static final String KEY_FORUM_NAME_STR = "Forum Name";
    public static final String KEY_FORUM_DESC_STR = "Forum Desc";
