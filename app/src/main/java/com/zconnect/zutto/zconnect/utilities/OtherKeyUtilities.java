...
/**
 * Created by aayush on 13/2/18.
 */

public class OtherKeyUtilities {

    //Notification Settings
    public static final String KEY_CABPOOL="AddCabPool";
    public static final String KEY_CABPOOL_JOIN="CabPool";
