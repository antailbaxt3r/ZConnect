...
public class CommentsRVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentsRVAdapter(ArrayList<ChatItemFormats> chatFormats, DatabaseReference databaseref, DatabaseReference reference, Context ctx) {
...
//        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == MessageTypeUtilities.KEY_MESSAGE) {
            View messageContactView = inflater.inflate(R.layout.open_status_commment_item_format, parent, false);
