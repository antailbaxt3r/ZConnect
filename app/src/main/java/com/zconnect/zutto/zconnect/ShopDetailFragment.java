...
//            menu.setImageURI(Uri.parse(menuurl));
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<GalleryFormat, ShopDetails.GalleryViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<GalleryFormat, ShopDetails.GalleryViewHolder>(
                GalleryFormat.class,
            ...
            @Override
            protected void populateViewHolder(ShopDetails.GalleryViewHolder viewHolder, GalleryFormat model, int position) {
        ...
        FirebaseRecyclerAdapter<GalleryFormat, ShopDetails.GalleryViewHolder> firebaseRecyclerAdapterMenu = new FirebaseRecyclerAdapter<GalleryFormat, ShopDetails.GalleryViewHolder>(
                GalleryFormat.class,
                R.layout.gallery_row,
                ShopDetails.GalleryViewHolder.class,
                mDatabaseMenu
